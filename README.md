...
<img src="https://komarev.com/ghpvc/?username=jagadish-4125&style=for-the-badge&color=0891b2&label=PROFILE+VIEWS"/>
&nbsp;
<img src="https://img.shields.io/github/followers/jagadish-4125?style=for-the-badge&logo=github&color=0891b2&label=FOLLOWERS"/>
...
class Jagadish:
    ...
    learning_now = [
        "⚡ PySpark + Hadoop Ecosystem",
        "🐘 PostgreSQL Advanced Queries",
        "☁️  AWS S3 · Glue · Redshift",
        "🏗️  Data Warehouse & Lakehouse Design",
        "🌬️  Apache Airflow Orchestration",
    ]

    strengths = {
        "mindset"    : "Builder, not just a learner",
        "approach"   : "Ship first, iterate always",
        "philosophy" : "Consistency > Motivation",
        "superpower" : "Turning chaos into clean data",
    }
...
| 📅 | Timeline | 10-Month Public Journey |
...
> 🌱 &nbsp;**Learning** — Big Data, Cloud, Pipelines &nbsp;|&nbsp; 🤝 &nbsp;**Open to** — Internships, Collabs, Projects &nbsp;|&nbsp; 💬 &nbsp;**Ask me** — ETL, Python, Data Engineering
